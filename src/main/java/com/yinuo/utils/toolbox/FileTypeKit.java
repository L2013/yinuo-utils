...
public class FileTypeKit {
	...
	static {
		...
		fileTypeMap.put("D0CF11E0A1B11AE10", "xls");// xls文件和msg文件一致
		fileTypeMap.put("504B030414000600080000002100413782CF", "xlsx");
		fileTypeMap.put("504B03041400000000007289AF4E00000000", "zip");
		fileTypeMap.put("504B030414000600080000002100DA50C82B", "docx");
