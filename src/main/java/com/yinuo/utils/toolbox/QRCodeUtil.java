...
public class QRCodeUtil {
	...
	public static String encode(String content, String logoPath, String destPath, String fileName, boolean needCompress)
			throws Exception {
		BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
		String formatFileName = fileName.substring(0, fileName.indexOf(".") > -1 ? fileName.indexOf(".") : fileName.length()) + "."
				+ FORMAT.toLowerCase();
	...
	private static String getFileName() {
		return new SimpleDateFormat("yyMMddHH").format(new Date()) + IdGen.uuid().toUpperCase() + "." + FORMAT.toLowerCase();
	}

	public static void main(String[] args) throws Exception {
		String text = "3086049002846739";
		// 不含Logo
